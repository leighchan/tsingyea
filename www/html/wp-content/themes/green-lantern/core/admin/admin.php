...
if (!function_exists('GL_info_page')) {
	...
	$page1=add_theme_page(__('Welcome to Green-Lantern', 'weblizar'), __('About Theme', 'weblizar'), 'edit_theme_options', 'green-lantern', 'GLdisplay_theme_info_page');
...
<div class="row theme-dtl guidline">
	<div class="col-md-6">
		...
		<p class="guidtext"><?php printf('1. For Home Page Go to Admin Dashboard >> Appearance >> Customize >> Theme Options >> Theme General Options. </br> Now Enable Show Front Page.', 'weblizar'); ?></p>
	   ...
	   <a href="<?php echo admin_url('customize.php'); ?>" class="customize_button"><?php _e('Customize Theme', 'weblizar'); ?></a>
		...
		<p class="faqtext"><?php _e("If you modify the theme and it upgrade with next updated version. Then your modifications will be lost. <br>If you want to protect your modifications then you create child theme. Child theme will ensure your modifications and speed up your development time ", "weblizar"); ?></p>
...
<div class="row proinfo">
	<div class="col-md-3">
	<h2> <?php printf(__('GREEN-LANTERN PREMIUM THEME', 'weblizar')); ?> </h2>
	...
	<ul> 
		...
		<li class="feature"><i class="fa fa-check fa-1x"></i> <?php printf(__('3 Portfolio Layout', 'weblizar')); ?></li>
	...
	<ul>
		...
		<li class="feature"><i class="fa fa-check fa-1x"></i> <?php printf(__('Service Page Template', 'weblizar')); ?></li>
		<li class="feature"><i class="fa fa-check fa-1x"></i> <?php printf(__('About Us Page with short-code', 'weblizar')); ?></li>
		<li class="feature"><i class="fa fa-check fa-1x"></i> <?php printf(__('Contact Us Page Template', 'weblizar')); ?></li>
		<li class="feature"><i class="fa fa-check fa-1x"></i> <?php printf(__('Custom Shortcodes', 'weblizar')); ?></li>
	</ul>
	</div>
	<div class="col-md-3 plan-feature">
		<ul>
		<li><a href="http://demo.weblizar.com/preview/#greenlantern" target="_new" class="demo_button"><i class="fa fa-check-circle"></i> Demo</a></li>
		<li><a href="https://weblizar.com/themes/green-lantern-premium-theme/" target="_new" class="purchase_button"><i class="fa fa-shopping-cart"></i> Buy</a></li>
		</ul>
	</div>
</div>
  ...
  <!-- Theme Premium Features  -->
	...
	<div class="col-md-12">
        <h1 class="section-title"> GREEN-LANTERN PREMIUM THEME FEATURES </h1>
		<div class="line"></div>
	     ...
	     <div class="col-md-12">
			...
			<div class="icon">
				...
				<h3> RESPONSIVE DESIGN </h3>
				 <p class="desc">Green-Lantern Pro adapts to different screen sizes so that your website will work (and be optimized for) iPhones, iPads and other mobile devices.</p>
		    </div>
			</div>
			...
			<div class="icon">
				...
				<h3> ISOTOPE EFFECTS </h3>
				 <p class="desc">Isotop effects for slider and portfolio.</p>
		    </div>
		    </div>
